...
@HiltViewModel
class ChatGPTUserInfoViewModel @Inject constructor(
    private val gptUserInfoRepositoryImpl: GPTUserInfoRepositoryImpl
) : ViewModel() {
    ...
    fun fetchUserInfo() {
        ...
        viewModelScope.launch {
            gptUserInfoRepositoryImpl.streamUserAsFlow().collect { user ->
                user?.let {
                    streamLog {
                        "User is $user"
                    }
